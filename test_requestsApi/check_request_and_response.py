...
class Checker:
    def check_request(self, response: requests.Response):
        ...
        #
        #
    def check_response_headers(self, response: requests.Response):
        ...
        #
        # print("\n---------------------------------------------------RESPONSE BODY--------------------------------------------------------")
    def check_response_body(self, response: requests.Response):
